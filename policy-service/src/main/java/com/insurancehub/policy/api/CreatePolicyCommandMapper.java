...
// Field names match across CreatePolicyRequest, reqId/inspId/txnId, and CreatePolicyCommand,
...
public interface CreatePolicyCommandMapper {
  ...
  CreatePolicyCommand toCommand(
      CreatePolicyRequest request, String reqId, String inspId, String txnId);
}
